				...
				<fieldset>
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<input type="text" class="form-control" name="fname" id="fname" maxlength="30"  placeholder="Aman ">
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<input type="text" class="form-control" name="lname" id="lname" maxlength="30" placeholder="kanthiwar">
							<p class="help-block"></p>
						</div>
					</div>
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<input type="text" class="form-control" name="faname" id="faname" maxlength="30" placeholder="Anil">
							<p class="help-block"></p>
						</div>
					</div>
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<input type="text" class="form-control" name="course" id="course" maxlength="10" placeholder="Btech">
							<p class="help-block"></p>
						</div>
					</div>
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<input type="Date" class="form-control" name="dob" id="dob" placeholder="21-10-2001">
							<p class="help-block"></p>
						</div>
					</div>
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<textarea class="form-control" name="addrs" id="addrs" placeholder="Hingna Nagpur"></textarea>
							<p class="help-block"></p>
						</div>
					</div>
...
Female</label>
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<input type="tel" pattern="^\d{10}$" required class="form-control" name="phno" id="phno" maxlength="10" placeholder="706209451">
							<p class="help-block"></p>
						</div>
					</div>
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<input type="text" class="form-control" name="email" id="email" maxlength="50" placeholder="amankanthiwar#gmail.com">
							<p class="help-block"></p>
						</div>
					</div>
