...
<header id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		...
		<div class="item">
			<div class="fill" style="background-image:url('images/CMS.jpg');"></div>
			<div class="carousel-caption">
		...
		<div class="item active">
			...
			<div class="carousel-caption">
				<a href="registrationform.php"><h2 style="color: white;">Register Today</h2></a>
			</div>
		</div>
		<div class="item">
			<div class="fill" style="background-image:url('images/1900x10803.png');"></div>
			<div class="carousel-caption">
				<a href="takeassessment.php"><h2 style="color: white; ">Take Assessment</h2>
                </div>
            </div>
        </div>
...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
                    Welcome to CMS Student-Teacher connection Network
                </h1>
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">Student-Teacher connection Network</h2>
		</div>
