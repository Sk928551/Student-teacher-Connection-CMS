...
<meta charset="utf-8">
    ...
    <title>Student-Teacher connection Network</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Student-Teacher connection Network</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
                     ...
                     <li>
                        <a href="takeassessment.php">Take Assessment</a>
                    </li>
                    <li>
                        <a href="viewresult.php">Result</a>
                    </li>
  					<li>
                        <a href="postquerypublic.php">Post Qurey</a>
                    </li>
					<li class="dropdown">
